...
const mockData = {
  ...
  recentActivities: [
    { id: 1, type: 'call', title: 'Call with John Doe', time: '10:30 AM', contact: 'John Doe', status: 'completed' },
    { id: 2, type: 'meeting', title: 'Meeting with ABC Corp', time: '2:00 PM', contact: 'Sarah Smith', status: 'upcoming' },
    { id: 3, type: 'email', title: 'Follow-up email sent', time: '4:45 PM', contact: 'Mike Johnson', status: 'completed' },
    { id: 4, type: 'task', title: 'Prepare proposal', time: '11:00 AM', contact: 'ABC Corp', status: 'pending' },
    { id: 5, type: 'note', title: 'Meeting notes updated', time: '3:30 PM', contact: 'Emma Wilson', status: 'completed' }
  ],
  topLeads: [
    { id: 1, name: 'ABC Corporation', value: 50000, stage: 'Proposal', days: 3 },
    { id: 2, name: 'XYZ Enterprises', value: 35000, stage: 'Negotiation', days: 5 },
    { id: 3, name: 'Tech Solutions Inc', value: 25000, stage: 'Qualified', days: 2 }
  ],
  performance: {
    conversionRate: 28,
    avgResponseTime: 2.5,
...
export default function DashboardScreen() {
  ...
  const renderActivityIcon = (type: string, status: string) => {
    const iconName = activityIcons[type as keyof typeof activityIcons] || 'help-outline';
    const color = status === 'completed' ? '#4CAF50' : status === 'upcoming' ? '#FF9800' : colors.primary;
  ...
  const renderLeadStage = (stage: string) => (
    <View style={[styles.stageBadge, { backgroundColor: stageColors[stage as keyof typeof stageColors] + '20' }]}>
      <Text style={[styles.stageText, { color: stageColors[stage as keyof typeof stageColors] }]}>
        {stage}
      </Text>
    </View>
  );
      ...
      >
        ...
        <Animated.View style={[styles.header, { 
          ...
          <View style={styles.headerTop}>
            ...
            <TouchableOpacity style={[styles.notificationBtn, { backgroundColor: colors.primary + '15' }]}>
              <Ionicons name="notifications-outline" size={24} color={colors.primary} />
              <View style={[styles.notificationDot, { backgroundColor: colors.error }]} />
            </TouchableOpacity>
          </View>
          
          <ThemedText type="default" style={{ color: colors.textSecondary, marginTop: 4 }}>
        ...
        <ThemedView style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.actionsGrid}>
            <Link href="/(app)/contacts/new" asChild>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: colors.primary + '15' }]}>
                <View style={[styles.actionIcon, { backgroundColor: colors.primary }]}>
                  <Ionicons name="person-add" size={20} color="white" />
                </View>
                <ThemedText type="defaultSemiBold" style={[styles.actionText, { color: colors.primary }]}>
                  Add Contact
                </ThemedText>
              </TouchableOpacity>
            </Link>
            ...
            <Link href="/leads/new" asChild>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#4CAF5015' }]}>
                <View style={[styles.actionIcon, { backgroundColor: '#4CAF50' }]}>
                  <Ionicons name="trending-up" size={20} color="white" />
                </View>
                <ThemedText type="defaultSemiBold" style={[styles.actionText, { color: '#4CAF50' }]}>
                  Add Lead
                </ThemedText>
              </TouchableOpacity>
            </Link>
            ...
            <Link href="/(app)/tasks/new" asChild>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#FF980015' }]}>
                <View style={[styles.actionIcon, { backgroundColor: '#FF9800' }]}>
                  <Ionicons name="checkmark-circle" size={20} color="white" />
                </View>
                <ThemedText type="defaultSemiBold" style={[styles.actionText, { color: '#FF9800' }]}>
                  Add Task
                </ThemedText>
              </TouchableOpacity>
            </Link>
            ...
            <Link href="/activities" asChild>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#9C27B015' }]}>
                <View style={[styles.actionIcon, { backgroundColor: '#9C27B0' }]}>
                  <Ionicons name="calendar" size={20} color="white" />
                </View>
                <ThemedText type="defaultSemiBold" style={[styles.actionText, { color: '#9C27B0' }]}>
                  Log Activity
                </ThemedText>
              </TouchableOpacity>
            </Link>
            ...
            {mockData.recentActivities.slice(0, 4).map((activity) => (
              <TouchableOpacity key={activity.id} style={styles.activityItem}>
                ...
                <View style={styles.activityContent}>
                  ...
                  <ThemedText type="default" style={{ color: colors.textSecondary, fontSize: 12 }}>
                ...
                <View style={[
                  ...
                  { 
                    backgroundColor: activity.status === 'completed' ? '#4CAF5020' : 
                                   activity.status === 'upcoming' ? '#FF980020' : 
                                   colors.primary + '20' 
                  }
                ]}>
                  <ThemedText type="default" style={[
                    ...
                    { 
                      color: activity.status === 'completed' ? '#4CAF50' : 
                             activity.status === 'upcoming' ? '#FF9800' : 
                             colors.primary 
                    }
                  ]}>
        ...
        <ThemedView style={[styles.section, { backgroundColor: colors.card }]}>
          <View style={styles.sectionHeader}>
            <ThemedText type="subtitle">Top Leads</ThemedText>
          ...
          <View style={styles.leadsList}>
            {mockData.topLeads.map((lead) => (
              <TouchableOpacity key={lead.id} style={styles.leadItem}>
        ...
        <ThemedView style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.metricsGrid}>
            <View style={styles.metricItem}>
              <ThemedText type="title" style={[styles.metricValue, { color: '#4CAF50' }]}>
            ...
            <View style={styles.metricItem}>
              <ThemedText type="title" style={[styles.metricValue, { color: '#2196F3' }]}>
            ...
            <View style={styles.metricItem}>
              <ThemedText type="title" style={[styles.metricValue, { color: '#FF9800' }]}>
        ...
        <View style={[styles.syncStatus, { backgroundColor: colors.card }]}>
          <View style={styles.syncInfo}>
            ...
            <ThemedText type="default" style={{ marginLeft: 8, color: colors.textSecondary }}>
