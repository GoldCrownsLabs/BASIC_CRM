...
const importantFeatures = [
  ...
  const recentItems = [
    ...
    { id: 3, name: 'Q4 Proposal', type: 'opportunity', lastActive: '3 days ago' },
  ];
  ...
  const getItemIcon = (type: string) => {
    switch(type) {
      ...
      case 'opportunity': return 'trending-up-outline';
    ...
    <Animated.View style={[
          ...
          <View style={styles.profileInfo}>
            ...
            <View style={styles.profileStats}>
              <View style={styles.statItem}>
                <Text style={[styles.statValue, { color: 'white' }]}>Sales</Text>
                <Text style={[styles.statLabel, { color: 'rgba(255,255,255,0.8)' }]}>Manager</Text>
              </View>
              <View style={styles.statDivider} />
              <View style={styles.statItem}>
                <Text style={[styles.statValue, { color: 'white' }]}>28%</Text>
                <Text style={[styles.statLabel, { color: 'rgba(255,255,255,0.8)' }]}>Conversion</Text>
              </View>
            </View>
          </View>
      ...
      >
          ...
          <View style={styles.themeOptions}>
            ...
            <TouchableOpacity
              style={[
                styles.themeOption,
                { 
                  backgroundColor: theme === 'system' ? colors.primary + '20' : 'transparent',
        ...
        <View style={[styles.syncSection, { backgroundColor: colors.card }]}>
          ...
          <TouchableOpacity style={[styles.syncButton, { backgroundColor: colors.primary + '15' }]}>
        ...
        <View style={[styles.infoSection, { backgroundColor: colors.card }]}>
          <Text style={[styles.infoTitle, { color: colors.text }]}>CRM Pro</Text>
