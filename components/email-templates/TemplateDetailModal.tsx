...
export const TemplateDetailModal: React.FC<Props> = ({
  ...
  const handleSendPress = () => {
    console.log("🔵 Send button clicked - opening recipient selector");
  ...
  const handleCloseRecipientSelector = () => {
    console.log("🟠 Closing recipient selector");
    setShowRecipientSelector(false);
  };
  ...
  return (
    <Modal visible={visible} transparent animationType="slide">
      <View style={styles.modalOverlay}>
        ...
        {/* Recipient Selector Modal - Now INSIDE the main Modal's View hierarchy */}
        {template && (
          <RecipientSelectorModal
            visible={showRecipientSelector}
            onClose={handleCloseRecipientSelector}
